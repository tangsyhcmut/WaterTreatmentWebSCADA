          ...
          <div className="select-mode">
            ...
            <Col>
              <FormGroup>
                ...
                <Button onClick={btnSetClick} className="btnset">
                  {" "}
                  SET{" "}
                </Button>
              </FormGroup>
            ...
            <Col>
              <FormGroup>
                <div className="controlbtn">
                  <Label>Control </Label>
                  <Button className="btnopen" onClick={btnOpenClick}>
                    Open
                  </Button>{" "}
                  <Button className="btnclose" onClick={btnCloseClick}>
                    Close
                  </Button>
          ...
          <Col>
            <FormGroup>
              <div className="valve-status-light">
                <Label>Opened</Label>
                <img
                  className="valveopenlight"
                  src={opened ? greenlighton : greenlightoff}
                />
                <Label>Closed</Label>
                <img
                  className="valvecloselight"
                  src={closed ? greenlighton : greenlightoff}
                />

                <Label> Fault </Label>
                <img
                  className="valvefaultlight"
