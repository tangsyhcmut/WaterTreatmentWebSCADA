...
exports._addMultiStateDiscrete = exports.promoteToMultiStateDiscrete = exports.UAMultiStateDiscrete = void 0;
/**
...
function promoteToMultiStateDiscrete(node) {
    ...
    node_opcua_assert_1.assert(_node.enumStrings.browseName.toString() === "EnumStrings");
...
register_node_promoter_1.registerNodePromoter(node_opcua_constants_1.VariableTypeIds.MultiStateDiscreteType, promoteToMultiStateDiscrete);
function _addMultiStateDiscrete(namespace, options) {
    ...
    if (typeof options.value === "number") {
        value = new node_opcua_variant_2.Variant({
