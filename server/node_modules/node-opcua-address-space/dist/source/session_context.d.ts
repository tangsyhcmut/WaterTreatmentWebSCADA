...
import { ISessionContext, UAObject, UAObjectType, UAVariable, UAMethod, BaseNode } from "./address_space_ts";
...
export declare class SessionContext implements ISessionContext {
     ...
     */
    checkPermission(node: UAMethod | UAVariable, requestedPermission: PermissionType): boolean;
